...
create_clock -name refclk         -period  $rx_link_clk_period [get_ports fpga_clk0_p]
create_clock -name refclk_replica -period  $rx_link_clk_period [get_ports fpga_clk0_replica_p]

# device clock
create_clock -name rx_device_clk     -period  $rx_device_clk_period [get_ports fpga_clk2_p]
create_clock -name tx_device_clk     -period  $tx_device_clk_period [get_ports fpga_clk3_p]
