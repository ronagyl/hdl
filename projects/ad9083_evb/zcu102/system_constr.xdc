...
#input
set_property  -dict {PACKAGE_PIN  Y4  IOSTANDARD LVDS}       [get_ports glblclk_p]       ; ## FMC_HPC0_LA00_CC_P
set_property  -dict {PACKAGE_PIN  Y3  IOSTANDARD LVDS}       [get_ports glblclk_n]       ; ## FMC_HPC0_LA00_CC_N
...
create_clock -period 2.5 -name rx_ref_clk2 [get_ports glblclk_p]
